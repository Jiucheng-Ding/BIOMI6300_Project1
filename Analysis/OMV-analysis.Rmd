...
```
Figure2:This scatterplot shows the OMV production change in log10. Each dot represents an individual sample.The blue solid has a y-intercept of 0, indicating that the values above this line have an increased OMV production; those below represent those with lowered OMV production level.
...
ggplot(data=vesiculation) +
  ...
  geom_vline(aes(xintercept=0, color="No Change in OMV"), size=0.7, linetype="solid") +
  geom_vline(aes(xintercept=mean(vesiculation$average.log.OMV), color="Mean"), size=0.7, linetype="dashed") +
  scale_color_manual(values=c("No Change in OMV"="blue", "Mean"="orange")) +
  labs(title="Distribution of OMV production in log10", color="") 
